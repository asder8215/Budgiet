...
* All feature PRs will first be merged into the `dev` branch, which will go through significant testing,
...
Making GitHub issues is a form of contribution as well! If there are any issues or desired features you would like 
